<?php namespace Witooh\CustomBlade;
...
use Witooh\CustomBlade\CustomBladeCompiler;
use Config;
...
class CustomBladeServiceProvider extends ServiceProvider {
    ...
    {
        $this->package('witooh/custom-blade');
    }
        ...
        $resolver->register('blade', function() use ($app)
            {
                ...
                $compiler = new CustomBladeCompiler($app['files'], $cache);
